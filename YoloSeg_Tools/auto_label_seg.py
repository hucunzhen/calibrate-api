...
用法:
  ...
  python auto_label_seg.py --images-dir .../images/train --labels-dir .../labels/train --weights yolo11m-seg.pt
...
def main() -> int:
    ...
    ap.add_argument(
        ...
        help="分割权重路径或名称（YOLO11：yolo11n/s/m/l/x-seg.pt；兼容 yolov8*-seg.pt）",
    )
